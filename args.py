...
def get_args_parser():
    ...
    parser.add_argument('--drop-path', type=float, default=0.0, metavar='PCT',   # Note: Drop path is set to 0.0 at default.
    ...
    parser.add_argument('--tfold', type=int, metavar='N',
                        help='the fold of K-Fold')
    parser.add_argument('--testing_aug_num', type=int, default=1, metavar='N',
                        help='testing_aug_num')
    parser.add_argument('--pred_state', type=str, default='test',
                        help='prediction state')
    parser.add_argument('--num_instance_c', type=int, metavar='N',
                        help='num_instance_c')
    parser.add_argument('--has_aug', type=int, default=0, metavar='aug',
                        help='if perform augmentation')
    parser.add_argument('--crop-size', type=int, default=256,
                        help='crop image size')
    parser.add_argument('--extend_num', type=int, default=0,
                        help='extend_num')
    parser.add_argument('--in_chans', type=int, default=256,
                        help='number of input channels ')
    parser.add_argument('--num_classes', type=int, metavar='N',
                        help='num_classes')

    parser.add_argument('--data-path', default='~/dataset/data.csv', type=str, help='dataset path')
